...
typedef union {
	...
	struct __attribute__((__packed__)) {
		...
		unsigned int flags : CSP_ID_FLAGS_SIZE; //8
		unsigned int sport : CSP_ID_PORT_SIZE;  //6
		unsigned int dport : CSP_ID_PORT_SIZE;  //6
		unsigned int dst : CSP_ID_HOST_SIZE;  //5
		unsigned int src : CSP_ID_HOST_SIZE;  //5
		unsigned int pri : CSP_ID_PRIO_SIZE;  //2
#else
